$(document).ready(function(){
  ...
  $('button[data-action=add]').on("click", function (event) {
      ...
      var clone = $(this).closest('.value_editor_container').clone();
      clone.find('.value_editor_field input:first').val('');
      clone.find('.value_editor_field input:first').attr('name', item + '' + newindex);
