...
Some tooltips can be added on create/update/rename pages for each item.
...
For example to add a tooltip on mail item, edit or create ``/etc/service-desk/en.inc.php``:
