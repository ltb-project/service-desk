...
Service Desk requires authentication by default, but it can be disabled if authentication is managed by an external system:

.. code-block:: php

   $require_auth = false;

You can choose wich authentication method to use:
